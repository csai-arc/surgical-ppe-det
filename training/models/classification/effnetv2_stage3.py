...
class EffNetV2yoga(nn.Module):
    def __init__(self, cfgs1,cfgs2,cfgs3,cfgs4, num_classes=1000, width_mult=1.):
        ...
        self.yoga6_classifier = nn.Linear(output_channel, 2)
        ...
        ##########Decoder################
        self.bottleneck1 = BottleNeck(512, 256, upsample=True, p_drop=0.1, use_prelu=False)
        self.bottleneck2 = BottleNeck(256, 128, upsample=True, p_drop=0.1, use_prelu=False)
        self.bottleneck3 = BottleNeck(128, 64, upsample=True, p_drop=0.1, use_prelu=False)
    ...
    def forward(self, x):
        ...
        return yoga6_x, y2, y3#, yoga20_x, yoga82_x
...
def effnetv2_s(**kwargs):
    ...
    #    [2, 512, 4, 1, 1],
    #]
    return EffNetV2yoga(cfgs1,cfgs2,cfgs3,cfgs4, **kwargs)
